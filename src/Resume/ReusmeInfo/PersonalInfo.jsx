            ...
            <p hidden={!info?.profession} className='text-gray-800 font-semibold text-lg'>{info?.profession}</p>
                 ...
                 <div className='flex flex-wrap justify-center gap-x-4 gap-y-2 mt-3'>
                        ...
                        <div hidden={!info?.linkedInProfile} className='flex items-center gap-1'>
                                ...
                                <Linkedin width={13}/> 
                           <a className='text-[13px] text-gray-700 hover:underline ' target='_blank' rel="noopener noreferrer" href="https://jioresume.com/">{info?.linkedInProfile}</a>
                        ...
                        <div hidden={!info?.personalWebsite} className='flex items-center gap-1'>
                               ...
                               <Globe width={13}/>
                     <a className='text-[13px] text-gray-700 hover:underline ' target='_blank' rel="noopener noreferrer" href="https://jioresume.com/">{info?.personalWebsite}</a>
