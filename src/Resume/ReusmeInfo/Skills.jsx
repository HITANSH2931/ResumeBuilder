...
const Skills = ({id,color}) => {
  ...
  return (
          ...
          <div hidden={!skills} className='mt-8 flex flex-col gap-4.5'>
        
                   <strong style={{color:color}} className=' text-xl font-semibold w-fit'>Skills</strong>
        
                      <div style={{borderLeftColor:color}} className=" border-l-2 border-solid  pl-3 text-[15px] text-gray-700 font-semibold flex flex-wrap gap-x-4.5 gap-y-2.5 ">
