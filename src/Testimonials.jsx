  ...
  return (
    <div>
          ...
          <section id='testimonials'>
           ...
           <div className="flex w-fit mx-auto mt-5 justify-center items-center gap-2 text-sm text-blue-800 bg-blue-400/10 border border-indigo-200 rounded-full px-4 py-2">
            <BookUser width={18}/>
